  ...
  return (
    <header className="alma-nav">
      <div className="alma-nav__inner">
        <button className="alma-nav__mobile-btn" onClick={() => setMobileOpen(o => !o)}>
      ...
      <div className="hero__content">
        <div className="hero__left">
          ...
          <p className="hero__desc">
            Tự tay thiết kế áo lớp, áo trường với công cụ trực tuyến — kéo thả sticker, thêm chữ, chọn màu & AI hỗ trợ. Từ ý tưởng đến sản phẩm chỉ trong vài phút.
          </p>
          ...
          <div className="hero__pills">
            {[
              ...
              <span key={p.label} className="hero__pill">{p.icon} {p.label}</span>
            ))}
          </div>

          <div className="hero__cta">
            <Link to="/customizer" className="btn-hero-primary">✨ Thiết kế ngay →</Link>
            <Link to="/category" className="btn-hero-secondary">👕 Xem mẫu áo</Link>
          </div>

          <div className="hero__stats">
            <div className="hero__stat"><p className="hero__stat-num">500+</p><p className="hero__stat-lbl">Trường đối tác</p></div>
            <div className="hero__stat-divider" />
            <div className="hero__stat"><p className="hero__stat-num">10K+</p><p className="hero__stat-lbl">Áo đã in</p></div>
            <div className="hero__stat-divider" />
            <div className="hero__stat"><p className="hero__stat-num">100+</p><p className="hero__stat-lbl">Mẫu phôi sẵn</p></div>
          </div>
        </div>
        ...
        <div className="hero__right">
          ...
          <div className="hero__mockup">
            <div className="hero__mockup-bar">
              ...
              <span className="hero__mockup-title">ALMA Customizer — Thiết kế trực tuyến</span>
            </div>
            <div className="hero__mockup-body">
              <div className="hero__mockup-sidebar">
                {[
                  ...
                  <div key={i} className={`hero__thumb ${i === 0 ? 'hero__thumb--active' : ''}`}>
          ...
          <div className="hero__badge-float hero__badge-float--top">
            ...
            <div><p className="hero__badge-title">Miễn phí thiết kế</p><p className="hero__badge-sub">Chỉ tính phí in ấn</p></div>
          </div>
          <div className="hero__badge-float hero__badge-float--bottom">
            ...
            <div><p className="hero__badge-title">AI hỗ trợ thiết kế</p><p className="hero__badge-sub">Tạo họa tiết tự động</p></div>
          </div>
        </div>
      </div>
    </section>
...
function HowItWorks() {
  const steps = [
    { icon: '👕', color: 'linear-gradient(135deg,#3b82f6,#2563eb)', badge: 'Bước 1', badge_color: '#dbeafe', badge_text: '#2563eb', title: 'Chọn Phôi Áo', desc: 'Hơn 100 mẫu phôi từ áo thun, polo, sơ mi đến hoodie. Đa dạng kiểu dáng để bạn lựa chọn.' },
    { icon: '🎨', color: 'linear-gradient(135deg,#6366f1,#9333ea)', badge: 'Bước 2', badge_color: '#e0e7ff', badge_text: '#4f46e5', title: 'Tự Thiết Kế Online', desc: 'Kéo thả sticker, thêm chữ, chọn màu, logo trường. AI hỗ trợ tạo họa tiết độc đáo chỉ bằng mô tả.' },
    { icon: '🚚', color: 'linear-gradient(135deg,#22c55e,#059669)', badge: 'Bước 3', badge_color: '#dcfce7', badge_text: '#16a34a', title: 'Đặt Hàng & Nhận Áo', desc: 'Chọn size cho cả lớp, thanh toán online. Áo được in chất lượng cao và giao tận nơi.' },
  ];
  return (
    ...
    <section className="section section--gray">
      <div className="section__container">
        ...
        <div className="gallery-grid">
          {gallery.map((g, i) => (
            <Link key={i} to="/product-detail" className={`gallery-card ${g.offset ? 'gallery-card--offset' : ''}`}>
...
// ── Testimonials ──────────────────────────────────────────────────────
const reviews = [
  { stars: 5, text: '"Thiết kế áo cực dễ, cả lớp mình chỉ mất 30 phút là xong. Chất lượng in rất đẹp, màu sắc y hệt bản preview!"', name: 'Trần Hùng', role: 'Lớp trưởng K18 — ĐH FPT', initials: 'TH', color: 'linear-gradient(135deg,#3b82f6,#6366f1)' },
  { stars: 5, text: '"Mình rất thích tính năng AI, chỉ cần mô tả ý tưởng là có ngay họa tiết. Giao hàng nhanh, đóng gói cẩn thận."', name: 'Linh Nguyễn', role: 'CLB Tình nguyện — ĐH Bách khoa', initials: 'LN', color: 'linear-gradient(135deg,#ec4899,#9333ea)' },
  { stars: 4.5, text: '"Đặt 50 áo cho lớp, giá cực hợp lý. Công cụ customizer rất chuyên nghiệp, thao tác dễ hiểu ngay từ lần đầu."', name: 'Minh Phát', role: 'BCS Lớp — HV Tài chính', initials: 'MP', color: 'linear-gradient(135deg,#22c55e,#059669)' },
];
  ...
  return (
    <section className="cta-section">
      ...
      <div className="cta-section__content">
        <h2 className="cta-section__title">Bạn đã sẵn sàng<br />thiết kế áo trường lớp?</h2>
        <p className="cta-section__sub">Bắt đầu miễn phí ngay hôm nay. Chỉ cần vài phút để tạo ra chiếc áo lớp mang đậm chất riêng của bạn.</p>
      ...
      <div className="alma-footer__inner">
        ...
        <div className="alma-footer__social">
          ...
          <div className="alma-footer__socials">
            <a href="#" className="alma-footer__social-btn" aria-label="Facebook">f</a>
            <a href="#" className="alma-footer__social-btn" aria-label="Instagram">📷</a>
            <a href="#" className="alma-footer__social-btn" aria-label="TikTok">♪</a>
          </div>
        </div>
      </div>
