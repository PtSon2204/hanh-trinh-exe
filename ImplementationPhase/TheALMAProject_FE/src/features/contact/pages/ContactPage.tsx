...
// ── Reuse Navbar & Footer từ HomePage ──────────────────────────────────
function Navbar() {
      ...
      <header className="alma-nav">
        <div className="alma-nav__inner">
          ...
          <nav className="alma-nav__links">
            ...
            <Link to="/Story" className="alma-nav__link alma-nav__link--hide-md">Câu chuyện</Link>
            <Link to="/orders" className="alma-nav__link alma-nav__link--hide-md">Đơn hàng</Link>
            <Link to="/contact" className="alma-nav__link alma-nav__link--active">Liên hệ</Link>
